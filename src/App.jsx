...
import AdminAiLabs from './pages/AdminAiLabs';
import AdminBellSystem from './pages/AdminBellSystem';
        ...
        <Box bg={bg} minH="100vh">
          <Layout>
            <Routes>
              ...
              <Route path="/admin/bell-system" element={<RequireAdmin extraRoles={['alerter','checker','sa']}><AdminBellSystem /></RequireAdmin>} />
